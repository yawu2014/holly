...
opt_parser.add_option("-r","--routing-key",dest="routing_key",help="Routing key for message")
...
print ("Send Message %s target with routing key '%s' to exchange") % (json.dumps(args.message),args.routing_key)